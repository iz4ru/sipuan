...
@section('title', 'SIPUAN - Registrasi Admin')
    ...
    <div class="flex-1 flex flex-col">
        <div class="p-6">
            <div class="flex items-center gap-6 px-8 py-4">
                <a href="{{ route('admin.login') }}" class="text-gray-600 hover:text-gray-800 transition-colors items-center flex gap-2">
                ...
                <div class="flex flex-col -translate-y-4 items-center justify-center gap-8">
                    ...
                    <div class="bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-8 w-full">
                        <div class="flex flex-col items-center justify-center gap-2 mb-6">
                            <p class="text-gray-700 text-center font-bold text-3xl">Ayo Isi!</p>
                            <p class="text-gray-500 text-center">Anda akan mendaftar sebagai admin pertama <span class="font-bold">SIPUAN</span>
                                </p>
                        </div>
                        ...
                        <form action="{{ route('admin.register.store') }}" method="POST"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <i
                                            class="fa fa-user absolute left-4 top-1/2 -translate-y-1/2 text-gray-300"></i>
                                        <input wire:model="name" placeholder="Masukkan Nama" type="text"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input wire:model="email" placeholder="Masukkan Email" type="email"
