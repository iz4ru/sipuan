                        ...
                        <div class="my-8 pb-16 lg:pb-0 w-full">
                            <div class="flex flex-col lg:flex-row w-full gap-4 px-4 md:px-8">
                                ...
                                <div
                                    ...
                                    <p class="text-gray-700 text-lg font-medium text-start">Hai! Silakan berikan ulasan dan
                                        saran untuk saya. Terima kasih! :)</p>

                                    <!-- Tag Input Section -->
                                    <div x-data="{
                                        tags: [],
                                        availableTags: ['Responsif', 'Profesional', 'Solutif'],
                                        moreTags: ['Tepat Waktu', 'Komunikatif', 'Ramah', 'Cepat Tanggap'],
                                        showModal: false,
                                        maxTags: 3
                                    }"
                                            ...
                                            <div class="flex flex-wrap gap-2 items-start justify-start">
                                                ...
                                                <template x-for="tag in availableTags" :key="tag">
                                                    <button type="button"
                                                        ...
                                                        class="px-4 py-1.5 rounded-full transition-colors text-sm font-medium select-none
                        "
                                                ...
                                                <!-- Add More Button -->
                                                <button @click="if(tags.length < maxTags) showModal = true"
                                        ...
                                        <div x-show="showModal" @click.outside="showModal = false"
                                            ...
                                            <div x-transition:enter="transition ease-out duration-150 transform"
                                                ...
                                                <h2 class="text-xl font-semibold text-[#05C1FF] mb-4 text-center">Pilih Tag
                                                    Tambahan</h2>
                        ...
                        "
                                                ...
                                                <div class="flex justify-center">
                                                    <button @click="showModal = false"
                                                        class="px-5 py-2 bg-[#05C1FF] text-white rounded-md hover:bg-[#0494da] text-sm font-semibold select-none focus:outline-none focus:ring-2 focus:ring-[#05C1FF] focus:ring-offset-1 transition">
                                                        Selesai
                                                    </button>
                                                </div>
                                    ...
                                    <div>
                                        <p class="text-gray-500 mb-2 font-medium text-left">Berikan Nilai Terhadap Pelayanan
                                        </p>
                                        ...
                                        <div x-data="{ rating: 0, hoverRating: 0 }" class="flex gap-2 items-center mt-4">
                                            <template x-for="star in 5" :key="star">
                                                <button type="button" @mouseover="hoverRating = star"
                                                    ...
                                                    class="text-gray-400 transition-all transform duration-150 ease-in-out hover:scale-110 focus:outline-none"
                                    ...
                                    <div class="w-full border border-gray-200 rounded-lg p-4 bg-white/50 mt-1">
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <p class="text-gray-700">WhatsApp: <a href="#"
                                                        class="text-[#05C1FF] hover:underline">Klik Untuk Kirim Pesan</a>
                                                </p>
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <i class="fa-solid fa-envelope text-gray-600"></i>
                                                <p class="text-gray-700">E-mail: <a href="#"
                                                        class="text-[#05C1FF] hover:underline">Klik Untuk Kirim E-mail</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full flex justify-end mt-2">
                                        <button type="submit"
                                            class="mt-3 button bg-gradient-to-r from-[#05C1FF] to-[#0FA3FF] text-[#FAFAFA] justify-center px-8 py-2.5 rounded-md text-sm font-bold hover:from-[#0092C2] hover:to-[#006BAD] transition-colors flex items-center gap-1 sm:gap-2">
