        ...
        <div class="space-y-6">
            <div class="flex flex-col bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6">
                <div class="bg-gradient-to-r from-[#05C1FF]/20 to-[#0FA3FF]/20 rounded-lg shadow-lg p-6">
                    <div class="">
                        <h1 class="text-2xl lg:text-3xl font-bold text-[#0B8BDB] mb-2">Update Password Admin</h1>
                        <p class="text-sm text-[#0B8BDB] lg:text-base">Perbarui informasi password admin yang terdaftar dalam sistem.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center lg:items-start lg:text-left">
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <form action="{{ route('admin.mgmt.update_password', $user->uuid) }}" method="POST" onsubmit="validateForm(event)">
                            @csrf
                            @method('PUT')
                            <div class="space-y-4">
                                ...
                                <!-- Current Password -->
                                <div>
                                    <label for="password_current" class="text-gray-500 font-medium text-sm">Masukkan
                                        Password Saat Ini</label>
                                    <div class="relative">
                                        <i class="fa fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-gray-300"></i>
                                        <input placeholder="Password Saat Ini" type="password" name="password_current"
                                            id="password_current"
                                ...
                                <!-- Password -->
                                <div>
                                    <label for="password" class="text-gray-500 font-medium text-sm">Masukkan Password
                                        Baru</label>
                                    <div class="relative">
                                        <i class="fa fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-gray-300"></i>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input wire:model="password_confirmation" placeholder="Konfirmasi Password Baru"
                                            ...
                                            class="text-sm w-full h-14 pl-12 pr-12 placeholder:text-gray-300 border bg-gray-50 border-gray-300 focus:outline-offset-2 focus:outline-sky-400 rounded-md shadow-sm"
                                            required autocomplete="off">
                                        <i
                                            class="fa fa-eye absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 cursor-pointer togglePassword"></i>
                                    </div>
