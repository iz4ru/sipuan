        ...
        <div class="space-y-6">
            <div class="flex flex-col bg-white/30 backdrop-blur-lg rounded-xl shadow-lg p-6">
                <div class="bg-gradient-to-r from-[#05C1FF]/20 to-[#0FA3FF]/20 rounded-lg shadow-lg p-6">
                    <div class="">
                        <h1 class="text-2xl lg:text-3xl font-bold text-[#0B8BDB] mb-2">Tambahkan Tag</h1>
                        <p class="text-sm text-[#0B8BDB] lg:text-base">Tambahkan tag yang mencerminkan kualitas pelayanan
                            staf.</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center lg:items-start lg:text-left">
                    ...
                    <div class="w-full max-w-lg">
                        ...
                        <form action="{{ route('tag.store') }}" method="POST" onsubmit="validateForm(event)">
                            @csrf
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input placeholder="Masukkan Nama Tag" type="text" name="tag_name"
                                            id="tag_name" value="{{ old('tag_name') }}"
                                            ...
                                            required autocomplete="tag_name">
                                    </div>
                                </div>
